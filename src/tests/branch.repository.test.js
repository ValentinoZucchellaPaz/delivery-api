...
describe("Branch Repository (unit tests)", () => {
    ...
    describe("createBranch", () => {
        it("should insert a branch and return it", async () => {
            ...
            const res = await branchRepo.createBranch({ restaurant_id: 2, address: "A St", city: "City" });
    ...
    describe("createMenu", () => {
        it("should insert menu and return it", async () => {
            ...
            expect(db.query).toHaveBeenCalledWith(expect.stringContaining("INSERT INTO menus"), [2, "Lunch"]);
        });
    });
    ...
    describe("createMenuItems", () => {
        ...
        it("should insert multiple items", async () => {
            const items = [{ name: "Pizza", price: 10 }, { name: "Pasta", price: 12 }];
    ...
    describe("getAllMenusByBranch", () => {
        it("should return menus with items", async () => {
            ...
            db.query
                .mockResolvedValueOnce({ rows: menus })
    ...
    describe("deleteMenuItems", () => {
        ...
        it("should call db if items provided", async () => {
            ...
            expect(db.query).toHaveBeenCalledWith(expect.stringContaining("DELETE FROM menu_items"), [[1, 2, 3]]);
        });
    });
