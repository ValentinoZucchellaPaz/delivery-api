...
- Processing **orders**, updating their status from **pending** to **preparing** to **on the way** to **delivered**, and marking them as **paid** upon delivery (or before).
...
# You will also see a container names `delivery-redis` used for async queuing of orders.
```
